...
<div class="container">
  <section class="container">
    <div class="container">
    <center>
      <h2><u>Lesego Seritili</u></h2>
      <h3>I developed this site and will constantly maintain it and improve it from time to time.</h3>
    </center>
    </div>
  </section>
  <hr/>
  <section class="my-work">
    ...
    <center>
      ...
      <li class="list-group-item list-group-item">MYSQL</li>
      <li class="list-group-item list-group-item">VUE.js</li>
      <li class="list-group-item list-group-item">JavaScript</li>
      ...
      <p>This site works via a REST API that I created with PHP7 where the PHP scripts communicate with the MYSQL relational database to send a json response to the client.</p>
      <hr>
      <h4><u>Contacts</u></h4>
      ...
      <p>Mobile1: <span style="color:#007bff;">083 208 7080</span></p>
